...
/* ================================================
   ...
   ─────────────────────────────────────────────────
   Credentials are loaded from js/firebase-config.js
   which is excluded from Git via .gitignore.
   See js/firebase-config.example.js for setup guide.
   ================================================ */

// Read config injected by firebase-config.js (must load before this script)
